...
# --- Alertas --------------------------------------------------------------
st.subheader(":material/notifications: Alertas")
...
c1, c2 = st.columns(2)
with c1:
    st.subheader(":material/settings: Estado de las máquinas")
    if maquinas:
...
with c2:
    st.subheader(":material/inventory_2: Estado de las dimensiones activas")
    if asignaciones:
